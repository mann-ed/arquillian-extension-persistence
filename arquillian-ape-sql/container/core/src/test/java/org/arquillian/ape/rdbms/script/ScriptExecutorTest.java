...
public class ScriptExecutorTest {
    ...
    @Test
    public void should_execute_two_statements_when_script_contains_two_insert_statements_and_comment()
            throws Exception {
        // when
    ...
    public void should_execute_statements_with_custom_delimiter() throws Exception {
        ...
        scriptExecutor = spy(
                new ScriptExecutor(connection, scriptingConfiguration, new DefaultStatementSplitter("GO")));
    ...
    @Test
    public void should_execute_script_with_new_line_as_statement_delimiter_ommiting_trailing_comments()
            throws Exception {
        // given
        final ArgumentCaptor<String> statementsCaptor = ArgumentCaptor.forClass(String.class);
        scriptingConfiguration.setSqlStatementDelimiter(ScriptingConfiguration.NEW_LINE_SYMBOL);
        scriptExecutor = spy(new ScriptExecutor(connection, scriptingConfiguration,
                new DefaultStatementSplitter(ScriptingConfiguration.NEW_LINE_SYMBOL)));
