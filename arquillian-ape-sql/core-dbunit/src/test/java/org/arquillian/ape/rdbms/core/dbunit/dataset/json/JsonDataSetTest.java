...
class JsonDataSetTest {
    ...
    @Test
    void should_load_table_from_json_file() throws Exception {
        // given
        input = FileLoader.load("one-table.json");

        // when
        final JsonDataSet jsonDataSet = new JsonDataSet(input);
    ...
    @Test
    void should_load_all_columns_for_table_from_json_file() throws Exception {
        // given
        input = FileLoader.load("one-table.json");
    ...
    @Test
    void should_load_all_rows_for_table_from_json_file() throws Exception {
        // given
        input = FileLoader.load("one-table.json");
    ...
    @Test
    void should_load_all_rows_with_content_for_table_from_json_file() throws Exception {
        // given
        input = FileLoader.load("one-table.json");
    ...
    @Test
    void should_load_two_tables_from_json_file() throws Exception {
        // given
